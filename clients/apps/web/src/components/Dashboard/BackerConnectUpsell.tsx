...
const BackerConnectUpsell = () => {
  ...
  return (
    <div className="dark:bg-polar-900 dark:border-polar-700 dark:text-polar-300 flex items-center justify-between border-b border-blue-100 bg-blue-100 px-8 py-2 text-sm text-sm font-medium text-gray-700">
