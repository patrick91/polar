...
const Team = ({ org }: { org: Organization }) => (
  <Link
    className="dark:bg-polar-700 dark:text-polar-300 dark:hover:bg-polar-800  flex items-center gap-4 rounded-xl bg-blue-100 px-4 py-2 text-sm text-gray-900 transition duration-100 hover:bg-blue-100"
    href={`/team/${org.name}`}
  >
